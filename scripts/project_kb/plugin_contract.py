...
def validate_plugin_contract(root: Path) -> list[str]:
    ...
    if named_skills != expected_skills:
        errors.append("仓库必须且只能存在 context-atlas-init、context-atlas-navigate、context-atlas-review、context-atlas-add、context-atlas-revise、context-atlas-retire 和 context-atlas-upgrade 七个 Skills")
