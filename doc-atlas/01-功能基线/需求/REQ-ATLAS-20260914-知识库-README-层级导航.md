---
id: REQ-ATLAS-20260914-知识库-README-层级导航
type: requirement
...
# REQ-ATLAS-20260914-知识库-README-层级导航：知识库 README 层级导航
...
| SC-ATLAS-002 | 分类 README 可通过反向索引获得直接成员，新增 `FEATURE-功能基线-功能-AI-知识采集与确认` 时 README 内容不变化。 | 新增知识项回归测试 | 用户确认 |
...
- 不在 README 中生成人工成员清单。
- 本需求的实现结果由 FEATURE-功能基线-功能-完整核心模板与知识模型、FEATURE-功能基线-功能-Schema-驱动的确定性检查器 及 `EVID-变更与证据-验收证据-REQ-ATLAS-001-README-层级导航实现验收` 追溯，知识结构检查通过不替代业务确认。
